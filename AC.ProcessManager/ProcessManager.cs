...
namespace AC.ProcessManager
{
    public class SystemProcess
    {
        ...
        private static extern IntPtr PostMessage(IntPtr hWnd, KeyActions Msg, Keys wParam, IntPtr lParam);
        ...
        [DllImport("User32.dll")]
        private static extern IntPtr SendMessage(IntPtr hWnd, KeyActions Msg, Keys wParam, IntPtr lParam);
        ...
        {
            Utilities.Wrappers.Window.Flash(WindowHandle);
        }
        public void SetWindowTitle(string title)
        {
            Utilities.Wrappers.Window.SetTitle(WindowHandle, title);
        }
        public string GetWindowTitle()
        {
            return Utilities.Wrappers.Window.GetTitle(WindowHandle);
        }

        public void SendKey()
        {
            PostMessage(WindowHandle, KeyActions.KeyDown, Keys.KEY_UP, IntPtr.Zero);
            Thread.Sleep(1122);
            PostMessage(WindowHandle, KeyActions.KeyUp, Keys.KEY_UP, IntPtr.Zero);
        }
    }
    ...
    public class ProcessManager
    {
        ...
        public static IEnumerable<SystemProcess> GetProcesses()
        {
            ...
            return processes
                ...
                .Where(p => p.WindowHandle != IntPtr.Zero);
